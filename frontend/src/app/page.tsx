    ...
    <main className="mx-auto flex h-screen max-w-[1800px] flex-col gap-3 p-4">
      <header className="flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2">
          {hero.netInr !== null && (
            <Badge variant="outline" className="border-emerald-800 font-mono text-[9.5px] text-emerald-400">
          ...
          {hero.gate && (
            <Badge variant="outline" className="border-sky-800 font-mono text-[9.5px] text-sky-400">
              {hero.gate}
            </Badge>
          )}
      ...
      {guidedStep !== null && (
        <div className="flex items-center gap-3 rounded-lg border border-emerald-800/60 bg-emerald-950/30 px-4 py-2.5">
          <div className="flex items-center gap-1.5">
            {GUIDED_STEPS.map((_, i) => (
              <span
                key={i}
                className={`h-1.5 w-1.5 rounded-full ${
                  i < guidedStep ? "bg-emerald-600" : i === guidedStep ? "bg-emerald-300" : "bg-zinc-700"
                }`}
              />
            ))}
          </div>
          <p className="min-w-0 flex-1 text-[12px] leading-snug text-emerald-100/90">
            {GUIDED_STEPS[guidedStep]}
            {guidedStep === GUIDED_STEPS.length - 1 && (
              <a href="/evidence" className="ml-2 font-mono text-[11px] text-emerald-300 underline underline-offset-2">
                open /evidence →
              </a>
            )}
          </p>
